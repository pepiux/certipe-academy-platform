  ...
  return (
    <>
      ...
      <div className="flex justify-center gap-2 mt-4">
        ...
        <Button 
          variant="outline" 
          className="flex items-center justify-center gap-2 bg-[#1877F2] text-white hover:bg-[#0d65d9] border-[#1877F2]"
        ...
        <Button 
          variant="outline" 
          className="flex items-center justify-center gap-2 bg-[#0A66C2] text-white hover:bg-[#084b8a] border-[#0A66C2]"
